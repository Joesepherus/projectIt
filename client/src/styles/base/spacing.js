...
export const spacing = {
  ...
  space7: `${spacingFactor * 7}px`,  // 48
  space8: `${spacingFactor * 8}px`,  // 64
  space9: `${spacingFactor * 9}px`,  // 72
  space11: `${spacingFactor * 11}px`, // 104
  space13: `${spacingFactor * 13}px`, // 104
  space20: `${spacingFactor * 20}px`, // 104
  space25: `${spacingFactor * 25}px`, // 104
  space30: `${spacingFactor * 30}px`, // 104
  space35: `${spacingFactor * 35}px`, // 104
  space38: `${spacingFactor * 38}px`, // 104
  space40: `${spacingFactor * 40}px`, // 104
};